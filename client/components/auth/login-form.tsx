      ...
      <div className="w-full max-w-md">
        ...
        <Card className="shadow-xl border-border">
          ...
          <CardContent>
            ...
            <Button className="w-full gap-2 bg-transparent" disabled={isLoading} variant="outline">
            ...
            <p className="mt-6 text-center text-sm text-muted-foreground">
              ...
              <Link className="text-primary font-medium hover:underline" href={`/${locale}/register`}>
